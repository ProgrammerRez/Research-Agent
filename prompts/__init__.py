...
DEEP_RESEARCH_PROMPT=[
    ...
    ("human", "Generate a deep research blueprint for the following topic: {topic} and strictly output a List[str] not a Dict")
]
...
SHALLOW_RESEARCH_PROMPT=[
    ...
    ("human", "Generate a shallow, high-level research plan for the following topic: {topic} and strictly output a List[str] not a Dict")
]